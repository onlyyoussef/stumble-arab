...
export interface ITournament extends Document {
  ...
  Prizes?: Prize[];
  Winners?: Winner[];
  WebhookMessageId?: string; // ← ID رسالة الـ webhook لتحديثها عند كل تسجيل
}
...
const TournamentSchema = new Schema<ITournament>({
  ...
  WebhookMessageId: { type: String, required: false, default: null },
});
